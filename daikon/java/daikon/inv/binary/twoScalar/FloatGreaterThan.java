 ...
 * double scalars.
 **/
public final class FloatGreaterThan
  extends TwoFloat {
  ...
  public static final Logger debug
    = Logger.getLogger("daikon.inv.binary.twoScalar.FloatGreaterThan");
  ...
  protected FloatGreaterThan instantiate_dyn (PptSlice slice) /*@Prototype*/ {
  ...
  public InvariantStatus add(Object v1, Object v2, int mod_index, int count) {
    if (debug.isLoggable(Level.FINE)) {
      debug.fine("FloatGreaterThan" + ppt.varNames() + ".add("
                 + v1 + "," + v2
                 + ", mod_index=" + mod_index + ")"
                 + ", count=" + count + ")");
    }
