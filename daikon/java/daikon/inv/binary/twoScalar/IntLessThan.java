...
public final class IntLessThan
  ...
  protected /*@Prototype*/ IntLessThan() {
   super();
  }

  private static /*@Prototype*/ IntLessThan proto;

  /** Returns the prototype invariant for IntLessThan **/
  public static /*@Prototype*/ IntLessThan get_proto() {
    if (proto == null)
      proto = new /*@Prototype*/ IntLessThan ();
    return (proto);
  }
  ...
  protected IntLessThan instantiate_dyn (PptSlice slice) /*@Prototype*/ {
  ...
  protected Invariant resurrect_done_swapped() {
      ...
      IntGreaterThan result = new IntGreaterThan(ppt);
      return result;
  }
  ...
  public InvariantStatus add(Object v1, Object v2, int mod_index, int count) {
    if (debug.isLoggable(Level.FINE)) {
      debug.fine("IntLessThan" + ppt.varNames() + ".add("
                 + v1 + "," + v2
                 + ", mod_index=" + mod_index + ")"
                 + ", count=" + count + ")");
    }
  ...
  public boolean isExclusiveFormula(Invariant other) {
    ...
    // Also ought to check against LinearBinary, etc.
        ...
        if ((other instanceof IntEqual)
            || (other instanceof IntGreaterEqual)
