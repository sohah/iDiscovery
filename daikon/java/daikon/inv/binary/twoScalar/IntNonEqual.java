...
public final class IntNonEqual
  ...
  protected /*@Prototype*/ IntNonEqual() {
   super();
  }

  private static /*@Prototype*/ IntNonEqual proto;

  /** Returns the prototype invariant for IntNonEqual **/
  public static /*@Prototype*/ IntNonEqual get_proto() {
    if (proto == null)
      proto = new /*@Prototype*/ IntNonEqual ();
    return (proto);
  }
  ...
  protected IntNonEqual instantiate_dyn (PptSlice slice) /*@Prototype*/ {
