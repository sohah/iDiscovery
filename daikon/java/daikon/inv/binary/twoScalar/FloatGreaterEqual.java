...
public final class FloatGreaterEqual
  ...
  protected /*@Prototype*/ FloatGreaterEqual() {
   super();
  }

  private static /*@Prototype*/ FloatGreaterEqual proto;

  /** Returns the prototype invariant for FloatGreaterEqual **/
  public static /*@Prototype*/ FloatGreaterEqual get_proto() {
    if (proto == null)
      proto = new /*@Prototype*/ FloatGreaterEqual ();
    return (proto);
  }
  ...
  protected FloatGreaterEqual instantiate_dyn (PptSlice slice) /*@Prototype*/ {
