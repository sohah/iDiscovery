 ...
 * String scalars.
 **/
public final class StringLessThan
  extends TwoString {
  ...
  public static final Logger debug
    = Logger.getLogger("daikon.inv.binary.twoScalar.StringLessThan");

  protected StringLessThan(PptSlice ppt) {
   super(ppt);
  }

  protected /*@Prototype*/ StringLessThan() {
   super();
  }

  private static /*@Prototype*/ StringLessThan proto;

  /** Returns the prototype invariant for StringLessThan **/
  public static /*@Prototype*/ StringLessThan get_proto() {
    if (proto == null)
      proto = new /*@Prototype*/ StringLessThan ();
    return (proto);
  }
  ...
  protected StringLessThan instantiate_dyn (PptSlice slice) /*@Prototype*/ {
  ...
  public InvariantStatus add(Object v1, Object v2, int mod_index, int count) {
    if (debug.isLoggable(Level.FINE)) {
      debug.fine("StringLessThan" + ppt.varNames() + ".add("
                 + v1 + "," + v2
                 + ", mod_index=" + mod_index + ")"
                 + ", count=" + count + ")");
    }
