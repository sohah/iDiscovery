...
public final class StringNonEqual
  ...
  protected /*@Prototype*/ StringNonEqual() {
   super();
  }

  private static /*@Prototype*/ StringNonEqual proto;

  /** Returns the prototype invariant for StringNonEqual **/
  public static /*@Prototype*/ StringNonEqual get_proto() {
    if (proto == null)
      proto = new /*@Prototype*/ StringNonEqual ();
    return (proto);
  }
  ...
  protected StringNonEqual instantiate_dyn (PptSlice slice) /*@Prototype*/ {
