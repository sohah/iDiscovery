 ...
 **/
public final class SeqFloatGreaterThan
  extends SequenceFloat
{
  ...
  protected SeqFloatGreaterThan(PptSlice ppt) {
    super(ppt);
  }

  protected /*@Prototype*/ SeqFloatGreaterThan() {
    super();
  }

  private static /*@Prototype*/ SeqFloatGreaterThan proto;

  /** Returns the prototype invariant for SeqFloatGreaterThan **/
  public static /*@Prototype*/ SeqFloatGreaterThan get_proto () {
    if (proto == null)
      proto = new /*@Prototype*/ SeqFloatGreaterThan ();
    return (proto);
  }
  ...
  protected SeqFloatGreaterThan instantiate_dyn (PptSlice slice) /*@Prototype*/ {
    return new SeqFloatGreaterThan (slice);
  }
  ...
  public SeqFloatGreaterThan clone() {
    SeqFloatGreaterThan result = (SeqFloatGreaterThan) super.clone();
    return result;
  }

  public String repr() {
    return "SeqFloatGreaterThan" + varNames() + ": "
      + ",falsified=" + falsified;
  }
  ...
  public static /*@Nullable*/ SeqFloatGreaterThan find(PptSlice ppt) {
    assert ppt.arity() == 2;
    for (Invariant inv : ppt.invs) {
      if (inv instanceof SeqFloatGreaterThan)
        return (SeqFloatGreaterThan) inv;
    }
    return null;
  }
  ...
  private static NISuppressee suppressee
    = new NISuppressee (SeqFloatGreaterThan.class, 2);
