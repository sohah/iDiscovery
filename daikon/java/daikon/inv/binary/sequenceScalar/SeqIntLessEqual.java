 ...
 **/
public final class SeqIntLessEqual
  extends SequenceScalar
{
  ...
  protected SeqIntLessEqual(PptSlice ppt) {
    super(ppt);
  }

  protected /*@Prototype*/ SeqIntLessEqual() {
    super();
  }

  private static /*@Prototype*/ SeqIntLessEqual proto;

  /** Returns the prototype invariant for SeqIntLessEqual **/
  public static /*@Prototype*/ SeqIntLessEqual get_proto () {
    if (proto == null)
      proto = new /*@Prototype*/ SeqIntLessEqual ();
    return (proto);
  }
  ...
  protected SeqIntLessEqual instantiate_dyn (PptSlice slice) /*@Prototype*/ {
  ...
  public SeqIntLessEqual clone() {
    SeqIntLessEqual result = (SeqIntLessEqual) super.clone();
    return result;
  }

  public String repr() {
    return "SeqIntLessEqual" + varNames() + ": "
      + ",falsified=" + falsified;
  }
  ...
  private static NISuppressee suppressee
    = new NISuppressee (SeqIntLessEqual.class, 2);
