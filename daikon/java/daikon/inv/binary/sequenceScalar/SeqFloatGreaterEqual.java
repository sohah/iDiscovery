  ...
  extends SequenceFloat
{
  ...
  protected /*@Prototype*/ SeqFloatGreaterEqual() {
    super();
  }

  private static /*@Prototype*/ SeqFloatGreaterEqual proto;

  /** Returns the prototype invariant for SeqFloatGreaterEqual **/
  public static /*@Prototype*/ SeqFloatGreaterEqual get_proto () {
    if (proto == null)
      proto = new /*@Prototype*/ SeqFloatGreaterEqual ();
    return (proto);
  }
  ...
  protected SeqFloatGreaterEqual instantiate_dyn (PptSlice slice) /*@Prototype*/ {
  ...
  public static /*@Nullable*/ SeqFloatGreaterEqual find(PptSlice ppt) {
    assert ppt.arity() == 2;
