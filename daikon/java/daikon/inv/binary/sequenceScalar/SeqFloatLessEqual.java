  ...
  extends SequenceFloat
{
  ...
  protected SeqFloatLessEqual(PptSlice ppt) {
    super(ppt);
  }

  protected /*@Prototype*/ SeqFloatLessEqual() {
    super();
  }

  private static /*@Prototype*/ SeqFloatLessEqual proto;

  /** Returns the prototype invariant for SeqFloatLessEqual **/
  public static /*@Prototype*/ SeqFloatLessEqual get_proto () {
    if (proto == null)
      proto = new /*@Prototype*/ SeqFloatLessEqual ();
    return (proto);
  }
  ...
  protected SeqFloatLessEqual instantiate_dyn (PptSlice slice) /*@Prototype*/ {
  ...
  public SeqFloatLessEqual clone() {
