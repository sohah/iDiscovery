  ...
  implements Comparison
{
  ...
  protected SeqSeqIntGreaterEqual(PptSlice ppt, boolean order) {
    super(ppt);
    orderMatters = order;
  }

  protected /*@Prototype*/ SeqSeqIntGreaterEqual(boolean order) {
    super();
    orderMatters = order;
  }

  protected SeqSeqIntGreaterEqual(SeqSeqIntLessEqual seq_swap) {
    super(seq_swap.ppt);
    orderMatters = seq_swap.orderMatters;
  }

  private static /*@Prototype*/ SeqSeqIntGreaterEqual proto;

  /** Returns the prototype invariant for SeqSeqIntGreaterEqual **/
  public static /*@Prototype*/ SeqSeqIntGreaterEqual get_proto() {
    if (proto == null)
      proto = new /*@Prototype*/ SeqSeqIntGreaterEqual (true);
    return (proto);
  }
  ...
  protected SeqSeqIntGreaterEqual instantiate_dyn (PptSlice slice) /*@Prototype*/ {
    boolean has_order = slice.var_infos[0].aux.getFlag(VarInfoAux.HAS_ORDER)
                      && slice.var_infos[1].aux.getFlag(VarInfoAux.HAS_ORDER);
    return new SeqSeqIntGreaterEqual(slice, has_order);
  }
  ...
  private static NISuppressee suppressee
    ...
    private static NISuppressor
      v1_pw_v2 = new NISuppressor (0, 1, PairwiseIntGreaterEqual.class);
