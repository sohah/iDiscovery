  ...
  implements Comparison
{
  ...
  protected SeqSeqIntEqual instantiate_dyn (PptSlice slice) /*@Prototype*/ {
  ...
  public String repr() {
    return "SeqSeqIntEqual" + varNames() + ": "
