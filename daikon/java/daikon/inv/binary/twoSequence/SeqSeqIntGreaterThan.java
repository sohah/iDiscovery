 ...
 **/
public class SeqSeqIntGreaterThan
  extends TwoSequence
  implements Comparison
{
  ...
  protected SeqSeqIntGreaterThan(PptSlice ppt, boolean order) {
    super(ppt);
    orderMatters = order;
  }

  protected /*@Prototype*/ SeqSeqIntGreaterThan(boolean order) {
    super();
    orderMatters = order;
  }
  ...
  protected SeqSeqIntGreaterThan instantiate_dyn (PptSlice slice) /*@Prototype*/ {
  ...
  public String repr() {
    return "SeqSeqIntGreaterThan" + varNames() + ": "
  ...
  private static NISuppressee suppressee
    = new NISuppressee (SeqSeqIntGreaterThan.class, 2);

    // Suppressor definitions (used in suppressions below)
    private static NISuppressor
      v1_pw_v2 = new NISuppressor (0, 1, PairwiseIntGreaterThan.class);
