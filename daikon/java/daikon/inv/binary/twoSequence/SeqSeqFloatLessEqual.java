 ...
 **/
public class SeqSeqFloatLessEqual
  ...
  implements Comparison
{
  ...
  protected SeqSeqFloatLessEqual(PptSlice ppt, boolean order) {
    super(ppt);
    orderMatters = order;
  }

  protected /*@Prototype*/ SeqSeqFloatLessEqual(boolean order) {
    super();
    orderMatters = order;
  }
  ...
  protected SeqSeqFloatLessEqual instantiate_dyn (PptSlice slice) /*@Prototype*/ {
  ...
  public String repr() {
    return "SeqSeqFloatLessEqual" + varNames() + ": "
  ...
  private static NISuppressee suppressee
    = new NISuppressee (SeqSeqFloatLessEqual.class, 2);

    // Suppressor definitions (used in suppressions below)
    private static NISuppressor
      v1_pw_v2 = new NISuppressor (0, 1, PairwiseFloatLessEqual.class);
