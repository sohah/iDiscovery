...
public class PairwiseStringLessThan
  extends TwoSequenceString
{
  ...
  protected PairwiseStringLessThan instantiate_dyn (PptSlice slice) /*@Prototype*/ {
  ...
  private static NISuppressee suppressee
    = new NISuppressee (PairwiseStringLessThan.class, 2);
