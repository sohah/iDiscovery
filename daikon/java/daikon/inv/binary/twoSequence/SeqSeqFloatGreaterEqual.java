 ...
 **/
public class SeqSeqFloatGreaterEqual
  ...
  implements Comparison
{
  ...
  protected SeqSeqFloatGreaterEqual(PptSlice ppt, boolean order) {
    super(ppt);
    orderMatters = order;
  }

  protected /*@Prototype*/ SeqSeqFloatGreaterEqual(boolean order) {
    super();
    orderMatters = order;
  }

  protected SeqSeqFloatGreaterEqual(SeqSeqFloatLessEqual seq_swap) {
    super(seq_swap.ppt);
    orderMatters = seq_swap.orderMatters;
  }

  private static /*@Prototype*/ SeqSeqFloatGreaterEqual proto;

  /** Returns the prototype invariant for SeqSeqFloatGreaterEqual **/
  public static /*@Prototype*/ SeqSeqFloatGreaterEqual get_proto() {
    if (proto == null)
      proto = new /*@Prototype*/ SeqSeqFloatGreaterEqual (true);
    return (proto);
  }
  ...
  protected SeqSeqFloatGreaterEqual instantiate_dyn (PptSlice slice) /*@Prototype*/ {
    boolean has_order = slice.var_infos[0].aux.getFlag(VarInfoAux.HAS_ORDER)
                      && slice.var_infos[1].aux.getFlag(VarInfoAux.HAS_ORDER);
    return new SeqSeqFloatGreaterEqual(slice, has_order);
  }

  protected Invariant resurrect_done_swapped() {

    return new SeqSeqFloatLessEqual(this);
  }

  public String repr() {
    return "SeqSeqFloatGreaterEqual" + varNames() + ": "
  ...
  public String format_using(OutputFormat format) {
    // System.out.println("Calling SeqSeqFloatGreaterEqual.format for: " + repr());
  ...
  public static /*@Nullable*/ SeqSeqFloatGreaterEqual find(PptSlice ppt) {
    assert ppt.arity() == 2;
    for (Invariant inv : ppt.invs) {
      if (inv instanceof SeqSeqFloatGreaterEqual)
        return (SeqSeqFloatGreaterEqual) inv;
    }
    return null;
  }
  ...
  private static NISuppressee suppressee
    = new NISuppressee (SeqSeqFloatGreaterEqual.class, 2);

    // Suppressor definitions (used in suppressions below)
    private static NISuppressor
      v1_pw_v2 = new NISuppressor (0, 1, PairwiseFloatGreaterEqual.class);
