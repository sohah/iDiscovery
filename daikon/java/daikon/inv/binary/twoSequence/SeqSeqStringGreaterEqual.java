 ...
 **/
public class SeqSeqStringGreaterEqual
  ...
  implements Comparison
{
  ...
  protected SeqSeqStringGreaterEqual instantiate_dyn (PptSlice slice) /*@Prototype*/ {
  ...
  public String repr() {
    return "SeqSeqStringGreaterEqual" + varNames() + ": "
  ...
  private static NISuppressee suppressee
    = new NISuppressee (SeqSeqStringGreaterEqual.class, 2);
