  ...
  extends TwoSequence
{
  ...
  protected /*@Prototype*/ SuperSequence() {
    super();
  }

  private static /*@Prototype*/ SuperSequence proto;

  /** Returns the prototype invariant for SuperSequence **/
  public static /*@Prototype*/ SuperSequence get_proto() {
    if (proto == null)
      proto = new /*@Prototype*/ SuperSequence ();
    return (proto);
  }
  ...
  protected SuperSequence instantiate_dyn (PptSlice slice) /*@Prototype*/ {
...
;
  ...
  public /*@Nullable*/ DiscardInfo isObviousStatically(VarInfo[] vis) {
    ...
    DiscardInfo di = SuperSequence.isObviousSubSequence(this, subvar, supervar);
    if (di != null) {
      return di;
    }
