 ...
 **/
public class SeqSeqIntLessThan
  extends TwoSequence
  implements Comparison
{
   ...
   * Debugging logger.
   **/
  static final Logger debug = Logger.getLogger ("daikon.inv.binary.twoSequence.SeqSeqIntLessThan");

  static Comparator<long[]> comparator = new ArraysMDE.LongArrayComparatorLexical();

  boolean orderMatters;

  protected SeqSeqIntLessThan(PptSlice ppt, boolean order) {
    super(ppt);
    orderMatters = order;
  }

  protected /*@Prototype*/ SeqSeqIntLessThan(boolean order) {
    super();
    orderMatters = order;
  }

  protected SeqSeqIntLessThan(SeqSeqIntGreaterThan seq_swap) {
    super(seq_swap.ppt);
    orderMatters = seq_swap.orderMatters;
  }

  private static /*@Prototype*/ SeqSeqIntLessThan proto;

  /** Returns the prototype invariant for SeqSeqIntLessThan **/
  public static /*@Prototype*/ SeqSeqIntLessThan get_proto() {
    if (proto == null)
      proto = new /*@Prototype*/ SeqSeqIntLessThan (true);
    return (proto);
  }
  ...
  protected SeqSeqIntLessThan instantiate_dyn (PptSlice slice) /*@Prototype*/ {
    boolean has_order = slice.var_infos[0].aux.getFlag(VarInfoAux.HAS_ORDER)
                      && slice.var_infos[1].aux.getFlag(VarInfoAux.HAS_ORDER);
    return new SeqSeqIntLessThan(slice, has_order);
  }

  protected Invariant resurrect_done_swapped() {

    return new SeqSeqIntGreaterThan(this);
  }

  public String repr() {
    return "SeqSeqIntLessThan" + varNames() + ": "
  ...
  public String format_using(OutputFormat format) {
    // System.out.println("Calling SeqSeqIntLessThan.format for: " + repr());
  ...
  public static /*@Nullable*/ SeqSeqIntLessThan find(PptSlice ppt) {
    assert ppt.arity() == 2;
    for (Invariant inv : ppt.invs) {
      if (inv instanceof SeqSeqIntLessThan)
        return (SeqSeqIntLessThan) inv;
    }
    return null;
  }
  ...
  private static NISuppressee suppressee
    = new NISuppressee (SeqSeqIntLessThan.class, 2);

    // Suppressor definitions (used in suppressions below)
    private static NISuppressor
      v1_pw_v2 = new NISuppressor (0, 1, PairwiseIntLessThan.class);
