...
public class PairwiseFloatGreaterEqual
  extends TwoSequenceFloat
{
  ...
  protected PairwiseFloatGreaterEqual instantiate_dyn (PptSlice slice) /*@Prototype*/ {
  ...
  private static NISuppressee suppressee
    = new NISuppressee (PairwiseFloatGreaterEqual.class, 2);
