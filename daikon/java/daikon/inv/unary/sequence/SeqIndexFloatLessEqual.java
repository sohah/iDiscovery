...
public class SeqIndexFloatLessEqual extends SingleFloatSequence {
  ...
  private SeqIndexFloatLessEqual () /*@Prototype*/ {
    super ();
  }
  ...
  public SeqIndexFloatLessEqual instantiate_dyn (PptSlice slice) /*@Prototype*/ {
