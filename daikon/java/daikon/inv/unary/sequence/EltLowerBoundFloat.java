  ...
  extends SingleFloatSequence
{
  ...
  private /*@Prototype*/ EltLowerBoundFloat() {
    super ();
    // do we need a core?
  }

  private static /*@Prototype*/ EltLowerBoundFloat proto;

  /** Returns the prototype invariant for EltLowerBoundFloat **/
  public static /*@Prototype*/ EltLowerBoundFloat get_proto() {
    if (proto == null)
      proto = new /*@Prototype*/ EltLowerBoundFloat ();
    return (proto);
  }
  ...
  public EltLowerBoundFloat instantiate_dyn (PptSlice slice) /*@Prototype*/ {
  ...
  public static /*@Nullable*/ EltLowerBoundFloat find(PptSlice ppt) {
    assert ppt.arity() == 1;
