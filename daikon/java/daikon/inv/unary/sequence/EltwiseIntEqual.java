  ...
  extends EltwiseIntComparison
{
  ...
  protected EltwiseIntEqual(PptSlice ppt) {
    super(ppt);
  }

  protected /*@Prototype*/ EltwiseIntEqual() {
    super();
  }

  private static /*@Prototype*/ EltwiseIntEqual proto;

  /** Returns the prototype invariant for EltwiseIntEqual **/
  public static /*@Prototype*/ EltwiseIntEqual get_proto() {
    if (proto == null)
      proto = new /*@Prototype*/ EltwiseIntEqual ();
    return (proto);
  }
  ...
  protected EltwiseIntEqual instantiate_dyn (PptSlice slice) /*@Prototype*/ {
    return new EltwiseIntEqual(slice);
  }

  public EltwiseIntEqual clone() {
