...
public class EltwiseIntGreaterEqual
  extends EltwiseIntComparison
{
  ...
  private static /*@Prototype*/ EltwiseIntGreaterEqual proto;
  ...
  protected EltwiseIntGreaterEqual instantiate_dyn (PptSlice slice) /*@Prototype*/ {
    return new EltwiseIntGreaterEqual(slice);
  }

  public EltwiseIntGreaterEqual clone() {
    EltwiseIntGreaterEqual result = (EltwiseIntGreaterEqual) super.clone();
    return result;
  }

  public String repr() {
    return "EltwiseIntGreaterEqual" + varNames() + ": "
      + "falsified=" + falsified;
  }
