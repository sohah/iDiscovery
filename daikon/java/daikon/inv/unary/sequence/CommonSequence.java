  ...
  extends SingleScalarSequence
{
  ...
  protected CommonSequence instantiate_dyn (PptSlice slice) /*@Prototype*/ {
...
//         pre_buf.append("(< "+idx+i + " (select arrayLength " + name[0] + ")) ");
  ...
  public InvariantStatus add_modified(long[] a, int count) {
    ...
    for (int i=0; i<a.length; i++) {
      ...
      int ii = ArraysMDE.indexOf (intersect, a[i]);
      if ((ii != -1) &&
