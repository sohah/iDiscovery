...
public class EltwiseIntLessThan
  extends EltwiseIntComparison
{
  ...
  protected EltwiseIntLessThan(PptSlice ppt) {
    super(ppt);
  }

  protected /*@Prototype*/ EltwiseIntLessThan() {
    super();
  }

  private static /*@Prototype*/ EltwiseIntLessThan proto;

  /** Returns the prototype invariant for EltwiseIntLessThan **/
  public static /*@Prototype*/ EltwiseIntLessThan get_proto() {
    if (proto == null)
      proto = new /*@Prototype*/ EltwiseIntLessThan ();
    return (proto);
  }
  ...
  protected EltwiseIntLessThan instantiate_dyn (PptSlice slice) /*@Prototype*/ {
    return new EltwiseIntLessThan(slice);
  }

  public EltwiseIntLessThan clone() {
    EltwiseIntLessThan result = (EltwiseIntLessThan) super.clone();
    return result;
  }

  public String repr() {
    return "EltwiseIntLessThan" + varNames() + ": "
      + "falsified=" + falsified;
  }
  ...
  public boolean isSameFormula(Invariant other) {
    return (other instanceof EltwiseIntLessThan);
  }
