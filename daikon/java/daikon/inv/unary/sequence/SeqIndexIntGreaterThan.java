...
public class SeqIndexIntGreaterThan extends SingleScalarSequence {
  ...
  private SeqIndexIntGreaterThan () /*@Prototype*/ {
    super ();
  }
  ...
  public SeqIndexIntGreaterThan instantiate_dyn (PptSlice slice) /*@Prototype*/ {
