  ...
  implements OneOf
{
  ...
  public EltOneOfFloat (PptSlice slice) {
    ...
    String.format ("ProglangType (var %s type %s) must be pseudo-array for %s",
                     var().name(), var().type, "EltOneOfFloat");
  ...
  public EltOneOfFloat instantiate_dyn (PptSlice slice) /*@Prototype*/ {
