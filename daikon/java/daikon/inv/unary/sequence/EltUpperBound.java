  ...
  extends SingleScalarSequence
{
  ...
  private /*@Prototype*/ EltUpperBound() {
    super ();
    // do we need a core?
  }

  private static /*@Prototype*/ EltUpperBound proto;

  /** Returns the prototype invariant for EltUpperBound **/
  public static /*@Prototype*/ EltUpperBound get_proto() {
    if (proto == null)
      proto = new /*@Prototype*/ EltUpperBound ();
    return (proto);
  }
  ...
  public EltUpperBound instantiate_dyn (PptSlice slice) /*@Prototype*/ {
