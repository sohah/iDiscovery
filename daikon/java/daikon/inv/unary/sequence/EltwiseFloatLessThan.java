  ...
  extends EltwiseFloatComparison
{
  ...
  protected EltwiseFloatLessThan instantiate_dyn (PptSlice slice) /*@Prototype*/ {
    return new EltwiseFloatLessThan(slice);
  }

  public EltwiseFloatLessThan clone() {
