  ...
  extends EltwiseFloatComparison
{
  ...
  protected /*@Prototype*/ EltwiseFloatLessEqual() {
    super();
  }

  private static /*@Prototype*/ EltwiseFloatLessEqual proto;

  /** Returns the prototype invariant for EltwiseFloatLessEqual **/
  public static /*@Prototype*/ EltwiseFloatLessEqual get_proto() {
    if (proto == null)
      proto = new /*@Prototype*/ EltwiseFloatLessEqual ();
    return (proto);
  }
  ...
  protected EltwiseFloatLessEqual instantiate_dyn (PptSlice slice) /*@Prototype*/ {
