  ...
  extends SingleFloat
{
  ...
  public LowerBoundFloat instantiate_dyn (PptSlice slice) /*@Prototype*/ {
    return new LowerBoundFloat (slice);
  }

  public LowerBoundFloat clone() {
   ...
   * a LowerBoundFloat invariant.  This code finds all of the min/max values
