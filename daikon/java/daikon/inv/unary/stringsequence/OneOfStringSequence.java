  ...
  implements OneOf
{
  ...
  private String[/*(at)Interned*/][] elts;
  ...
  public OneOfStringSequence instantiate_dyn (PptSlice slice) /*@Prototype*/ {
  ...
  public String[/*(at)Interned*/] min_elt() {
    if (num_elts == 0)
  ...
  public String[/*(at)Interned*/] max_elt() {
    if (num_elts == 0)
      throw new Error("Represents no elements");
    sort_rep();
  ...
  public boolean compare_rep(int num_other_elts, String[/*(at)Interned*/][] other_elts) {
  ...
  public InvariantStatus add_modified(String[/*(at)Interned*/] a, int count) {
    return runValue(a, count, true);
  }

  public InvariantStatus check_modified(String[/*(at)Interned*/] a, int count) {
    return runValue(a, count, false);
  }

  private InvariantStatus runValue(String[/*(at)Interned*/] v, int count, boolean mutate) {
   ...
   */
  public InvariantStatus add_mod_elem (String[/*(at)Interned*/] v, int count) {
   ...
   * of adding the sample to this.
   */
  public InvariantStatus check_mod_elem (String[/*(at)Interned*/] v, int count) {
  ...
  public /*@Nullable*/ Invariant merge (List<Invariant> invs, PptSlice parent_ppt) {
    ...
    for (int i = 1; i < invs.size(); i++ ) {
      ...
      for (int j = 0; j < inv.num_elts; j++) {
        String[/*(at)Interned*/] val = inv.elts[j];
   ...
   */
  public void set_one_of_val (String[/*(at)Interned*/][] vals) {
  ...
  public boolean state_match (Object state) {
    ...
    if (!(state instanceof String[/*(at)Interned*/][]))
      System.out.println ("state is of class '" + state.getClass().getName()
                          + "'");
    String[/*(at)Interned*/][] e = (String[/*(at)Interned*/][]) state;
    for (int i = 0; i < num_elts; i++) {
      boolean match = false;
