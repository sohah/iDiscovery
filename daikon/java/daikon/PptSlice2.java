...
public final class PptSlice2 extends PptSlice {
  ...
  public static final Logger debugSpecific
                    = Logger.getLogger("daikon.PptSlice2");

  public static final Logger debugMerge
                    = Logger.getLogger ("daikon.PptSlice.merge");

  /**
   * Create a new PptSlice2.  The var_infos must be in varinfo_index
   * order.
   **/
      ...
      for (Invariant orig_inv : cslice.invs) {
        ...
        if (Invariant.logOn()) {
          ...
          inv.log ("Created " + inv + " from " + orig_inv + " using permute "
                   ...
                   + VarInfo.arrayToString (cvis_sorted) + " cvis = "
                   + VarInfo.arrayToString (child_vars)
                   + " for ppt " + parent.name());
        }
      }
    }
