...
public class Chart {
	...
	public double TopLevel_Chart_Nofjets = 0;
	public double[] TopLevel_Chart_e = new double[2];
	public double TopLevel_Chart_Firefct1 = 0;
	public double TopLevel_Chart_Coastfct1 = 0;
	public double TopLevel_Chart_Firefct2 = 0;
	public double TopLevel_Chart_Coastfct2 = 0;
	public double TopLevel_Chart_tjcalc1 = 0;
	public double TopLevel_Chart_tjcalc = 0;
