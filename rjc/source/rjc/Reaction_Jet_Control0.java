...
public class Reaction_Jet_Control0 {
	//all changed into public from private
  public double[][] Value431 = new double[2][2];
  public double[][] Value463 = new double[2][2];
  public double[][] Value495 = new double[2][2];
  public double[] NumeratorCoefficients_3554 = new double[2];
  public double[] DenominatorCoefficients_4556 = new double[2];
  public double NumeratorTerms_5557 = 0;
  public double DenominatorTerms_6558 = 0;
  public double[] NumeratorCoefficients_7588 = new double[2];
  public double[] DenominatorCoefficients_8590 = new double[2];
  public double NumeratorTerms_9591 = 0;
  public double DenominatorTerms_10592 = 0;
  public double[] NumeratorCoefficients_11614 = new double[2];
  public double[] DenominatorCoefficients_12616 = new double[2];
  public double NumeratorTerms_13617 = 0;
  public double DenominatorTerms_14618 = 0;
  public Yaw_Control_Law1 Yaw_Control_Law_100000076_class_member15 = new Yaw_Control_Law1();
  public v_Control_Law2 v_Control_Law_100000084_class_member16 = new v_Control_Law2();
  public u_Control_Law3 u_Control_Law_100000081_class_member17 = new u_Control_Law3();
