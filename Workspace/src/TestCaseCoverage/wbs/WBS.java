...
//						   assert false;
	...
	public static void launch(int pedal1, boolean auto1, boolean skid1,
		...
		if (maxSteps-- > 0) wbs.update(pedal1, auto1, skid1);
		if (maxSteps-- > 0) wbs.update(pedal2, auto2, skid2);
	...
	public static void main(String[] args) {
		launch(0,false,false,0,false,false,0,false,false, 0, false, false, 0, false, false);
	}
}
