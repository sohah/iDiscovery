package TestCaseCoverage.nanoxml;/* XMLParserFactory.java                                           NanoXML/Java
 *
 * $Revision: 1.2 $
...
public class XMLParserFactory
{
     ...
     */
    public static final String DEFAULT_CLASS = "net.n3.nanoxmlTCG.StdXMLParser";
    
    
    /**
     * The class name of the default XML validator.
     */
    public static final String VALIDATOR_CLASS = "net.n3.nanoxmlTCG.NonValidator";
    
    
    /**
     * The Java properties key of the XML parser class name.
     */
    public static final String CLASS_KEY = "net.n3.nanoxmlTCG.XMLParser";
