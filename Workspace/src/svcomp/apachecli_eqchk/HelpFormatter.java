...
public class HelpFormatter {
   ...
   *
   * @deprecated Scope will be made private for next major version - use get/setWidth methods
   *     instead.
   */
   ...
   *
   * @deprecated Scope will be made private for next major version - use get/setLeftPadding methods
   *     instead.
   */
   ...
   * the number of characters of padding to be prefixed to each description line
   *
   * @deprecated Scope will be made private for next major version - use get/setDescPadding methods
   *     instead.
   */
   ...
   *
   * @deprecated Scope will be made private for next major version - use get/setSyntaxPrefix methods
   *     instead.
   */
   ...
   * the new line string
   *
   * @deprecated Scope will be made private for next major version - use get/setNewLine methods
   *     instead.
   */
   ...
   * the shortOpt prefix
   *
   * @deprecated Scope will be made private for next major version - use get/setOptPrefix methods
   *     instead.
   */
   ...
   * the long Opt prefix
   *
   * @deprecated Scope will be made private for next major version - use get/setLongOptPrefix
   *     methods instead.
   */
   ...
   *
   * @deprecated Scope will be made private for next major version - use get/setArgName methods
   *     instead.
   */
   ...
   *
   * <p>Defaults to case-insensitive alphabetical sorting by option key
   */
   ...
   *
   * <p>Passing in a null parameter will set the ordering to the default mode
   */
   ...
   */
  public void printHelp(
      int width, String cmdLineSyntax, String header, Options options, String footer) {
  ...
  /**
   * Appends the usage clause for an OptionGroup to a StringBuffer. The clause is wrapped in square
  ...
  public void printUsage(PrintWriter pw, int width, String cmdLineSyntax) {
    ...
    printWrapped(
        pw, width, defaultSyntaxPrefix.length() + argPos, defaultSyntaxPrefix + cmdLineSyntax);
  }
  ...
  protected StringBuffer renderOptions(
      StringBuffer sb, int width, Options options, int leftPad, int descPad) {
  ...
  protected StringBuffer renderWrappedText(
      StringBuffer sb, int width, int nextLineTabStop, String text) {
   ...
   * with the column width <code>width</code>. The wrap point is the last postion before
   ...
   * @return postion on which the text must be wrapped or -1 if the wrap position is at the end of
   *     the text
   */
  ...
  private static class OptionComparator implements Comparator {
    ...
    public int compare(Object o1, Object o2) {
      ...
      char _key1 = opt1.getKey();
      char _key2 = opt2.getKey();
      if (_key1 > _key2) {
        return 1;
      } else if (_key1 == _key2) {
        return 0;
