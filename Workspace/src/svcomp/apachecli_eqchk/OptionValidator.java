...
class OptionValidator {
  /**
   * Validates whether <code>opt</code> is a permissable Option shortOpt. The rules that specify if
   * the <code>opt</code> is valid are:
   *
   * <ul>
   *   <li><code>opt</code> is not NULL
   *   <li>a single character <code>opt</code> that is either ' '(special case), '?', '@' or a
   *       letter
   *   <li>a multi character <code>opt</code> that only contains letters.
   * </ul>
   *
