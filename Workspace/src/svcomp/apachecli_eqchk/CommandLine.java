...
public class CommandLine implements Serializable {
   ...
   * Java properties like <tt>-Dparam1=value1 -Dparam2=value2</tt>. The first argument of the option
   * is the key, and the 2nd argument is the value. If the option has only one argument
   * (<tt>-Dfoo</tt>) it is considered as a boolean flag and the value is <tt>"true"</tt>.
   *
   * @param opt name of the option
   * @return The Properties mapped by the option, never <tt>null</tt> even if the option doesn't
   *     exists
   * @since 1.2
   */
  ...
  */
   ...
   *
   * @return an <code>Iterator</code> over the processed {@link Option} members of this {@link
   *     CommandLine}
   */
