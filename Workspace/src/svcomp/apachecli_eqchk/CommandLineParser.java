...
public interface CommandLineParser {
   ...
   * @param options the specified Options
   * @param arguments the command line arguments
   * @param stopAtNonOption specifies whether to continue parsing the arguments if a non option is
   *     encountered.
   * @return the list of atomic option and value tokens
   * @throws ParseException if there are any problems encountered while parsing the command line
   *     tokens.
   */
  CommandLine parse(Options options, char[][] arguments, boolean stopAtNonOption)
      throws ParseException;
