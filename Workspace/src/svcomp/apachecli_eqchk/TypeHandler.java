...
/**
 * This is a temporary implementation. TypeHandler will handle the pluggableness of OptionTypes and
 * it will direct all of these types of conversion functionalities to ConvertUtils component in
...
public class TypeHandler {
  ...
  public static Object createObject(String classname) throws ParseException {
    ...
    try {
      ...
      throw new ParseException("Unable to find the class: " + classname, 42);
    }
    ...
    try {
      ...
      throw new ParseException(
          e.getClass().getName() + "; Unable to create an instance of: " + classname, 42);
    }
   ...
   *
   * @param str the value
   * @return the number represented by <code>str</code>, if <code>str</code> is not a number, null
   *     is returned.
   */
  public static Number createNumber(String str) throws ParseException {
    try {
      ...
      throw new ParseException(e.getMessage(), 42);
    }
  }
  ...
  public static URL createURL(String str) throws ParseException {
    try {
      ...
      throw new ParseException("Unable to parse the URL: " + str, 42);
    }
  }
