...
public class BasicParser extends Parser {
  /**
   * A simple implementation of {@link Parser}'s abstract {@link Parser#flatten(Options, String[],
   * boolean) flatten} method.
   *
   * <p><b>Note:</b> <code>options</code> and <code>stopAtNonOption</code> are not used in this
