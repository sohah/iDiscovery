 ...
 * Parser#flatten(Options,char[][],boolean) flatten} method.
 *
...
public class PosixParser extends Parser {
  ...
  /**
   * Resets the members to their original state i.e. remove all of <code>tokens</code> entries and
   * set <code>eatTheRest</code> to false.
   */
  private void init() {
    eatTheRest = false;
    tokens.clear();
  ...
  /**
   * An implementation of {@link Parser}'s abstract {@link Parser#flatten(Options,char[][],boolean)
   * flatten} method.
   *
  ...
  /**
   * Add the special token "<b>--</b>" and the current <code>value</code> to the processed tokens
   * list. Then add all the remaining <code>argument</code> values to the processed tokens list.
   *
