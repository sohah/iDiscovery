 ...
 *
 * <p>Details on the Builder pattern can be found at <a
 * href="http://c2.com/cgi-bin/wiki?BuilderPattern">http://c2.com/cgi-bin/wiki?BuilderPattern</a>.
 *
...
public final class OptionBuilder {
  ...
  public static OptionBuilder hasArg(boolean hasArg) {
    if (hasArg) {
      ...
      OptionBuilder.numberOfArgs = Option.UNINITIALIZED;
    }
  ...
  public static Option create(char opt) throws IllegalArgumentException {
    String _opt = String.valueOf(opt);
    Option result = create(_opt);
    return result;
  ...
  public static Option create(String opt) throws IllegalArgumentException {
    ...
    try {
      // create the option
      option = new Option(opt.charAt(0), description);

      // set the option properties
      option.setLongOpt(longopt.charAt(0));
