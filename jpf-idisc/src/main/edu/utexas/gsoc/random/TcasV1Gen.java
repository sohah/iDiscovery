...
public class TcasV1Gen extends MetaGenerator {
	...
	public static void genCovDriver(boolean symbc, double ratio)
			throws IOException {
		TcasV1Gen gen = new TcasV1Gen();
		BufferedWriter writer = new BufferedWriter(
				new FileWriter(
						"/Users/zhanglingming/Research/tools/gsoc2013/svvat-nasa/GSoC2013/tcas/cov-subjects/v1"
		...
		List<String> symbcTests = SymbcInputGenerator
				.readSymbcOutput("/Users/zhanglingming/Research/tools/gsoc2013/svvat-nasa/GSoC2013/tcas/initial-tests/v1-symbolic_output.txt");
		...
		if (!symbc) {
			...
			BufferedWriter tstWriter = new BufferedWriter(
					new FileWriter(
							"/Users/zhanglingming/Research/tools/gsoc2013/svvat-nasa/GSoC2013/initial-inputs/tcas-v1-rand.txt"));
