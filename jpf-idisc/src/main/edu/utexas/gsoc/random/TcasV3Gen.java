...
public class TcasV3Gen extends MetaGenerator{
	...
	public static void genCovDriver(boolean symbc, double ratio) throws IOException {
		TcasV3Gen gen = new TcasV3Gen();
		BufferedWriter writer = new BufferedWriter(
				new FileWriter(
						"/Users/zhanglingming/Research/tools/gsoc2013/svvat-nasa/GSoC2013/tcas/cov-subjects/v3"
		...
		List<String> symbcTests = SymbcInputGenerator
				.readSymbcOutput("/Users/zhanglingming/Research/tools/gsoc2013/svvat-nasa/GSoC2013/tcas/initial-tests/v3-symbolic_output.txt");
		...
		if (!symbc) {
			...
			BufferedWriter tstWriter = new BufferedWriter(
					new FileWriter(
							"/Users/zhanglingming/Research/tools/gsoc2013/svvat-nasa/GSoC2013/initial-inputs/tcas-v3-rand.txt"));
