        ...
        for (String oldVar : invParser.oldVars.keySet()) {
            ...
            if (oldVar.contains("(")) {
                ...
                if (type.contains("[]")) {
                    ...
                    System.out.println(ASTTreeParser.typeMap);
...
//        for (int i = ASTTreeParser.endLine - 1; i < src.size(); i++) {
//            System.out.println("value of expression ASTTreeParser.endLine - 1 is = " + (ASTTreeParser.endLine - 1));
//            System.out.println("the src is" + src);
//            System.out.println("the i is" + i);
            ...
            writer.write(src.get(i) + "\n");}
                ...
                System.out.println("if exception raised, then its probably signature of the meth, in the .cfg file. Check line 158 in ASTTreeParser.");
